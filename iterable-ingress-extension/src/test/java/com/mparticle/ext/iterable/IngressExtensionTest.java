...
public class IngressExtensionTest {
    ...
    public void testProcessRegistrationRequest() throws Exception {
        ...
        List<Setting> accountSettings =
                response.getEventProcessingRegistration().getAccountSettings();
        assertTrue(
        ...
        assertTrue(
                "Iterable should support custom events",
                eventTypes.contains(Event.Type.CUSTOM_EVENT));
        assertTrue(
    ...
    public void testProcessAudienceMembershipChangeRequest() throws Exception {
        AudienceMembershipChangeResponse response =
                ingressExtension.processAudienceMembershipChangeRequest(
                        new AudienceMembershipChangeRequest());
        System.out.println();
        System.out.println(serializer.serialize(response));
        System.out.println();
    }
